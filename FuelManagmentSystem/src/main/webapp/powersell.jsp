   ...
   <section>
      ...
      <c:if test="${not empty errorMsg}">
       ...
       <table>
         ...
         <tr>
           <td>Sell Quantity: </td>
           <td> <input class="sq" type="text" placeholder="Sell quantity" name="sellqty" required></td>
         </tr> 
         ...
         <tr>
           <td>Total Stock: </td>
           <td><input class="ttls" type="text" placeholder="" name="totalStock" value="<%=power%>" required readonly></td>
         </tr> 
